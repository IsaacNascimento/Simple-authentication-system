...
<head>
    ...
    <!--====== Title ======-->
    <title>Early Toddler - Maple Bear</title>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <nav class="navbar navbar-expand-lg">
                                ...
                                <div style="font-family:'Times New Roman', Times, serif; color: #c00"> 
        ...
        <div id="home" class="header_hero d-lg-flex align-items-center" style="background-image: linear-gradient(to bottom, #F4F4F4, #fff);">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="header_hero_content mt-45 header_title wow fadeInLeftBig" data-wow-duration="1.3s" data-wow-delay="0.2s">
                            <p style="font-size: 25px; font-family: Raleway; color:#c00;">Valparaíso de Goiás</p>
                                <br>
                            <p style="font-size: 48px; font-family: Raleway; color:#c00;">TODDLER</p>
                                <br>
                            <p style="font-size: 16px; font-family: Raleway; color:#c00;">Ms. Verônica Aguiar</p>
                            </h2>
                            <br>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8" style="margin-bottom: -30px;">
                    <div class="single_features mt-30 features_1 text-center wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.2s">
                        ...
                        <div class="features_content">
                            ...
                            <a href="https://meet.google.com/oym-qnjh-drm">
                            ...
                            <br>
                            <a href="https://meet.google.com/oym-qnjh-drm">
                                <p> https://meet.google.com/oym-qnjh-drm</p>
                            </a>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single_features mt-30 features_2 text-center wow fadeInUp" data-wow-duration="1.3s" data-wow-delay="0.5s">
                        ...
                        <div class="features_content">
                            ...
                            <br>
                            para o email abaixo.
                            <a href="veronica.aguiar@te.maplebear.com.br">
                                <p> veronica.aguiar@te.maplebear.com.br</p>
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-12 col-md-6 col-sm-6">
                    <div class="about_image mt-50 wow fadeInRightBig" data-wow-duration="1.3s" data-wow-delay="0.5s">
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-lg-12 col-md-6 col-sm-6">
                                   <table class="table table-striped" style="border: 1px solid #ccc; text-align: center;">
                                        <style>
                                            table,
                                            th,
                                            tr,
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;" rowlspan="2" colspan="6">
                                                    <a href="../../">maplebearvalparaiso.com.br</a>
                                                </td>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    ...
                    <div class="footer_copyright text-center mt-55">
                        <p>Copyright &copy; 2021. Designed and Developed by <a href="#">Triplus</p></a>
                    </div>
                    <!-- footer copyright -->
                </div>
